  ...
  const TableRow = ({ record }) => (
    <tr className="border border-gray-300 hover:bg-gray-400/10 text-left">
      ...
      <td className="max-w-[300px] whitespace-normal p-2 border-l border-gray-200">
        <div className="flex flex-col items-start gap-1">
          <p className="text-black">{record.Date ? formatDate(new Date(`${record?.Date}T00:00:00`)) : 'TBA'}</p>
        </div>
      </td>
          ...
          <div className="overflow-x-auto">
            ...
            <div className="flex flex-col gap-3 mt-10 w-[97%]">
              ...
              <div className="flex gap-5">
                ...
                <p className="text-sm font-semibold italic text-gray-500 w-12">Add</p>
              ...
              <div className="flex gap-5">
                ...
                <p className="text-sm font-semibold italic text-gray-500 w-12">Subtract</p>
                <p className="text-sm italic text-gray-500 text-justify">
