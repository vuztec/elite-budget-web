        ...
        <table className="w-[99%]">
          <tbody>
            <tr className="border border-gray-300 text-left p-2">
              <td className="px-2 py-2 border-r w-2/3 border-gray-300">Total Annual Debts (Other)</td>
              <td className="px-2 font-bold">{getYearlyBudgetTotal(user, debtGridData)}</td>
            </tr>
            <tr className="border border-gray-300 text-left p-2">
            ...
            <tr className="border border-gray-300 text-left p-2">
              <td className="px-2 py-2 border-r w-2/3 border-gray-300">
                {owner === 'Joint' ? 'Over/Under' : getLabel(incomeGridData, debtGridData, 'Debts', maingoals)}
              </td>
              <td className="px-2 font-bold">
                {owner === 'Joint' ? '' : getDifference(incomeGridData, debtGridData, 'Debts', maingoals, user)}
              </td>
            </tr>
          </tbody>
        </table>
