...
const ModalWrapperFull = ({ open, handleClose, children }) => {
      ...
      <Dialog as="div" className="relative z-50 w-full" initialFocus={cancelButtonRef} onClose={handleClose}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className="w-full h-fit max-h-[90%] sm:h-fit overflow-y-auto relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all pb-0 sm:my-8 sm:w-[95%] max-w-[99%] lg:max-w-[90%] xl:max-w-[80%] 2xl:max-w-[70%]">
