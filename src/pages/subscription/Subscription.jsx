      ...
      <div className="w-full flex flex-col gap-5 xl:gap-10 bg-white p-5 mt-4  text-sm xl:text-[16px] rounded-lg">
        <div className="w-full xl:w-1/2 flex flex-col gap-5">
          ...
          <p className="text-justify">
            ...
            use only, limited to you only. This means you may view, download, print, email and use one copy of
            individual pages of the Program and Content for your own personal purposes or your own business only.
          </p>
