    ...
    <div className="w-full flex flex-col gap-5 xl:gap-10 bg-white p-5 mt-4  text-sm xl:text-[16px]">
      <div className="w-full xl:w-1/2 flex flex-col gap-5">
        ...
        <p className="text-justify">
          ...
          doubt, you are granted a revocable, non-transferable license for personal, non-commercial use only, limited to you only. This
          means you may view, download, print, email and use one copy of individual pages of the Program and Content for your own personal
          purposes or your own business only.
        </p>
        <p className="font-bold text-justify">
          You may not republish, reproduce, duplicate, copy, sell, display, disclose, distribute to friends, family, or any other third
          party, or otherwise use any material from the Program or Content for commercial purposes or in any way that earns you or any third
          party money (other than by applying them generally in your own business).
        </p>
        <p className="text-justify">
          By downloading, printing, or otherwise using the Program or Content for personal use, you in no way assume any ownership rights of
          the Content – it is still the property of Elite Cash Flow Consulting. Any unauthorized use of any materials found in the Program
          or Content shall constitute infringement. You must receive our written permission before using any of the Program or Content for
          your own commercial use or before sharing with others.
        </p>
      </div>
      <div className="w-full xl:w-1/2 flex flex-col gap-5">
